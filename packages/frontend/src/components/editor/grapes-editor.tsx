  ...
  function GrapesEditor({ initialContent, onChange, onSave, saving }, ref) {
    ...
    useEffect(() => {
      ...
      editor.Blocks.add('mj-raw', {
        ...
        content: '<mj-section background-color="#ffffff" padding="0" margin="0"><mj-column padding="0"><mj-raw><!-- Your custom HTML here --><p style="text-align:center;color:#999;font-size:12px;margin:0;">Custom HTML Block</p></mj-raw></mj-column></mj-section>',
      });
